...
public class dbHelper_UserDevices extends SQLiteOpenHelper {
    ...
    private static final  String CREATE_TABLE_DEVICE = " CREATE TABLE IF NOT EXISTS "
            ...
            + Config.COLUMN_DEVICE_CODE + " TEXT NOT NULL, "
            + Config.COLUMN_DEVICE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT)";


    public  dbHelper_UserDevices(Context context) {
        ...
        try{
            ...
            if(cursor != null) {
                ...
                do{
                    ...
                    String device_id = cursor.getString(cursor.getColumnIndex(Config.COLUMN_DEVICE_CODE));
                    deviceList.add(new Device(device_id,device_Name, device_State, device_Power));
